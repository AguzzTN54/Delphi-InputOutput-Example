...
Image1.Picture.LoadFromFile('pic/Sport/CBR2501.jpg');
...
Image1.Picture.LoadFromFile('pic/Sport/CBR2503.jpg');
...
procedure TForm9.Label9Click(Sender: TObject);
begin
Form9.Hide;
Form1.Show;
end;
...
Image1.Picture.LoadFromFile('pic/Sport/CBR2502.jpg');
...
procedure TForm9.Label7Click(Sender: TObject);
begin
Label8.Color := clWhite;
Label8.Font.Color := clRed;
Label3.Color := clWhite;
...
Image1.Picture.LoadFromFile('pic/Sport/CBR250.jpg');
